...
const Header = () => {
  ...
  return (
    <header className='sticky w-full p-3 top-0 bg-white z-20 py-4 border-b shadow-sm border-gray-100'>
      <div className='flex justify-between items-center'>
        ...
        <ul className='text-zinc-700 gap-2 md:gap-4 items-center hidden md:flex'>
          <li>
            <Link
              to='/'
